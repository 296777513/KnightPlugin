...
//        Log.i("liyachao", "name: " + method.getName() + "  args1: "+args.length);
        if ("startActivity".equals(method.getName())) {//startActivity方法
            ...
            newIntent.setClassName("com.knight.plugin", "com.knight.plugin.SubActivity");//启动目标SubActivity
            newIntent.putExtra(HookHelper.TRANSFER_INTENT, oldIntent);//保留原始intent
            Log.i("liyachao1", "name: " + oldIntent.getComponent().getClassName());
